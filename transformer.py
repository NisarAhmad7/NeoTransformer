...
Full Transformer with multi-head self-attention, cross-attention,
residual connections, layernorm, and masking for autoregressive NLP tasks.
...
class Transformer(nn.Module):
    def __init__(  # give this kind parametrs 
        self,
        src_vocab_size,
        trg_vocab_size,
        src_pad_idx,
